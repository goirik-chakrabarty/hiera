...
if wandb_enable:
    wandb.init(project="hiera-test", name="baseline_bs-lrscale_4")
...
full_paths = [path.join("/mnt/vast-react/projects/neural_foundation_model/", f) for f in paths]
...
sys.path.append('/user/chakrabarty1/u13071/hiera_sens')
if model_bkbn == 'hiera':
...
# tiny_hieradet = Hiera(#input_size=(screen_chunk_size, video_size[0], video_size[1]),
#                      num_heads=1,
#                      embed_dim=96,
#                      stages=(2, 1,), # 3 transformer layers 
#                      q_pool=1, 
...
print(hiera_output.shape) # (b, t, h, w, c): (8, 4, 9, 16, 192)
